...
def main() -> int:
    ...
    local_records = [
        ("limpo2.jpg", "limpo", "local-limpo-2020", "Foto local do projeto; conteúdo e rótulo revisados."),
        ("sujo19.jpg", "sujo", "local-sujo-2020", "Foto local do projeto; conteúdo e rótulo revisados."),
    ]
